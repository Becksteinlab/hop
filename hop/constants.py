...
__docs__ = """Constants that are being used throughout the hop module."""


r_water = 1.4   # Angstrom; conventional water van der Waals radius
...
N_Avogadro = 6.02214179e+23  # mol**-1   http://physics.nist.gov/cgi-bin/cuu/Value?na
...
# conversion_factor used by get_conversion_factor(type, unit1, unit2):
#
